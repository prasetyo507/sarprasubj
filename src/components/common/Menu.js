          ...
          <ul className="sidebar-menu" data-widget="tree">
            <li className="header">MAIN NAVIGATION</li>
            {
              menus.map(menu => 
                ...
                :
                  <li className={`${menu.class_name} ${_.some(menu.submenu, {destination: window.location.pathname}) ? "active" : null}`}>
                    <NavLink to={menu.destination}>
                    ...
                    <ul className="treeview-menu">
                      {
                        menu.submenu.map((sub, key) =>
                          <li className={sub.destination === window.location.pathname ? `active ${key}` : null}>
